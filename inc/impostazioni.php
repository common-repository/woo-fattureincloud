...
echo "<p><strong>La pagina checout di WooCommerce va corretta come illustrato nella documentazione <a href=\"https://woofatture.com/docs/checkout/\">https://woofatture.com/docs/checkout/</a></strong></p>";

set_transient( 'wfic_check_block_checkout', 1 , HOUR_IN_SECONDS );

} else {
    
    echo "<p>la pagina checkout di WooCommerce è impostata corretttamente</p>";

    set_transient( 'wfic_check_block_checkout', 0 , HOUR_IN_SECONDS );
